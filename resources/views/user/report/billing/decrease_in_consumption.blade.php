...
@section('title', 'Decrease in Consumption')
@section('content')
...
<p class="contentheader">Decrease in Consumption</p>
<div class="main">
...
<div id="meterReader" class="modal">
    <div class="modal-content" style="margin-top: 30px; width: 40%; height: 350px;">
        ...
        <div class="modal-body">
            <div class="meterReaderDiv" style="overflow-y: scroll; height: 265px;"> </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function printConskwh(){
        ...
        $url = '{{route("print_decrease_in_consumption")}}'
        window.open($url);
    }
</script>
@endsection
