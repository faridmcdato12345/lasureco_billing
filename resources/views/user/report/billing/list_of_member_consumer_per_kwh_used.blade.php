...
@section('title', 'List of Member-Consumer per kWh used')
@section('content')
...
<p class="contentheader">List of Member-Consumer per KWH used</p>
<div class="main">
    <br>
    <table class="content-table">
        ...
        <tr>
            ...
            <td>
                <input type="number" style="width: 42.5%;" id="from" placeholder="Start kWh" disabled> 
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; to
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                <input type="number" style="width: 42.5%;" id="to" placeholder="End kWh" disabled>
            </td>
        </tr>
        <tr>
            <td colspan=2>
...
<script>
    ...
    $(document).on('change', '#billPeriod', function(){
        ...
        document.querySelector('#from').disabled = (billperiod !== "") ? false : true;
        document.querySelector('#to').disabled = (billperiod !== "") ? false : true;
    });    
    ...
    $(document).on('change', '#from', function(){
        ...
        document.querySelector('.printButton').disabled = (from !== "" && to !== "") ? false : true;
    });
