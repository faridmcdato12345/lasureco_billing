...
@section('title', 'Uncollected Bills per Route')
@section('content')

<p class="contentheader"> Uncollected Bills per Route </p>
<div class="main">
    <table class="content-table">
        <tr>
            <td colspan=2> 
                <select name="UBPRS" style="width: 70%;"> 
        ...
        <tr> 
            ...
            <td> 
                <input type="text" name="noteBy" placeholder="Noted By">
            </td>
            <td colspan=2> 
                &nbsp; <input type="text" name="noteByPos" placeholder="Position">
            </td>
        </tr>
        <tr> 
            <td colspan=4> 
