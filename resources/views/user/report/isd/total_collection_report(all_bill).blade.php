...
@section('title', 'Total Collection Report(All Bill)')
@section('content')
...
<p class="contentheader">Total Collection Report(All Bill)</p>
<div class="main">
    <br>
...
<script>
    ...
    function print(){
        ...
        $url = '{{route("print_total_collection_report_all_bill")}}'
        window.open($url);
    }
</script>
@endsection
