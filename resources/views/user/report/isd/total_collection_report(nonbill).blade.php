...
@section('title', 'Total Collection Report(Non-Bill)')
@section('content')
...
<p class="contentheader">Total Collection Report (Non-Bill)</p>
<div class="main">
    <br>
...
<script>
    ...
    function print(){
        ...
        $url = '{{route("print_total_collection_report_non_bill")}}'
        window.open($url);
