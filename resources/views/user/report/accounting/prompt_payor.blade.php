...
@section('title', 'Prompt Payor')
@section('content')

<p class="contentheader">Prompt Payor</p>
<div class="main">
    <table style ="height:500px;" border="0" class="content-table">
        ...
        <tr>
            <td>
                <select class="form-select" style="width:auto;color:black" name=""  onchange= "selected1(this)" id="select">
                <option style="color:black" value="1" selected>by_date ASC</option>
                <option style="color:black" value="2">by_date DESC</option>
                <option style="color:black" value="3">by_amount ASC</option>
                <option style="color:black" value="4">by_amount DESC</option>
                </select>
            </td>
        </tr>
        <tr id="All">
        ...
        <tr>
            <td colspan="4">
                <button onclick="sendPromptPayor()" style="float:right;width:70px;margin-top:30px;height:40px;" class="btn btn-primary" >Print</button>
            </td>
        </tr>
    </table>
</div>
...
function selected1(b){
    tosend.sortby = parseInt(b.value);
}
...
function sendPromptPayor(){
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            var route = "{{route('report.isd.promptPayor')}}";
            var xhr = new XMLHttpRequest();
