...
<p class="contentheader">Change Status</p>
<div class="main">
    <div style="margin-top:30px;overflow-x:hidden;height:150px;width: 80%; margin-left: auto; margin-right: auto; color: white; background-color: #5B9BD5;">
        <table  style="margin:auto;width: 100%;">
                ...
                <tr style="background-color:white; color:black;border-bottom:1px solid black;">
                    ...
                    <td>
                        <button style="background-color:rgb(23, 108, 191);color:white;" class="modalBtn modal-button" href="#AMASA2">Select</button>
                    </td>
                </tr>
        </table>
    </div>
</div>
<div id="AMASA2" class="modal">
        <div class="modal-content" style="width: 70%;">
        <div class="modal-header" style="width: 100%;">
            <h3>Assign Main Account/ Sub Account</h3>
            <span class="closes" href="#AMASA2">&times;</span>
        </div>
        <div class="modal-body">
            ...
            <table border= 0 class="EMR-table" style="height:70px;">
                ...
                <tr>
                    <th>Remarks:</th>
                    <td>
                        <textarea style="width:250px;height:100px;" placeholder="Remarks"></textarea>
                    </td>
                </tr>
                <tr>
                    <td colspan=4>
