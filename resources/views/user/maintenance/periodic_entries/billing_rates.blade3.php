...
<script>
    ...
    function showRates(){
        ...
        xhr.onload = function(){
            if(this.status == 200){ 
                ...
                var output = "<tr id='thead'> <td> &nbsp; Consumer Type </td> <td style='text-align: center;'> <button id='printBRBtn' class='btn btn-light' onclick='printRates()'> Print Rates </buttin> </td> </tr>";
    ...
    function addBillRates(x){
        ...
        var viewRates = "{{route('get.rate', ['consType'=>':consType', 'billPeriod'=>':billPeriod'])}}";
        var newViewRates = viewRates.replace(':consType', consumerType);
        var newViewRates2 = newViewRates.replace(':billPeriod', date);
