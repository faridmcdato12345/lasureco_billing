               ...
               <div class="row">
                   <div class="col-6" style="border-right: solid">
                       <div id="chrges1" class="row">
                            ...
                            <input type="text" class="col-5" id="PrevGenChargeTotal" readonly>
                            ...
                            <input type="text" class="col-5" id="PrevTransChargeTotal" readonly> 
                            ...
                            <input type="text" class="col-5" id="PrevDistCharge" readonly>  
                            ...
                            <label class="col-5 input-check">Loan Conodation</label>
                            ...
                            <input type="text" class="col-5" id="PrevOtherCharge" readonly> 
                       </div> 
                   </div>
                   <div class="col-6">
                       <div class="row" id="chrges2">
                            ...
                            <label class="col-5 input-check" style="background: blue; color:white">SUB-TOTAL (GC)</label>
                            <input type="text" class="col-5" id="PrevGovCharge" readonly>  
                            ...
                            <input type="text" class="col-5" id="PreVAT" readonly>
               ...
               <div class="row">
                   <div class="col-6" style="border-right: solid">
                       <div id="chrges1" class="row">
                            ...
                            <label class="col-5">Loan Conodation</label>
...
<script>
    // function getRates(){
        ...
        // var billRates = "{{route('index.billrates')}}";
        // var date = new Date();
        // xhr.open('GET', billRates, true);
        // xhr.send();
        // xhr.onload = function(){
            var l = "{{Auth::id()}}";
        //     if(this.status == 200){
        //         var respo = JSON.parse(this.responseText);
        //         // var currentPeriod = respo.Billing_Period;
        //         var data = respo.data;
        //         var CurrBillMonth = date.getFullYear()+"-"+(date.getMonth()+1);
        //         console.log(CurrBillMonth);
        //         var output = "<tr id='thead'> <td> &nbsp; Consumer Type </td> <td colspan=2 style='text-align: center;'> Action </td> </tr>";
        //         // var monthstring = JSON.stringify(month);
        //         // var billMonth = monthstring.slice(0,4);
        //         // billMonth = billMonth+"-"+ monthstring.slice(4,6);
        //         for(var x in data){
        //             output += "<tr> <td> &nbsp;&nbsp;" + data[x].ct_desc + "</td>";
                    
        //             if(data[x].id !== ""){
        //                 if(data[x].id > 0){
        //                     output += "<td style='text-align: center;'> <button class='previewBtn'> Preview </td>";
        //                     output += "<td style='text-align: center;'> <button disabled> Create </td> </tr>";
        //                 } else {
        //                     output += "<td style='text-align: center;'> <button disabled> Preview </td>";
        //                     output += "<td style='text-align: center;'> <button onclick='addBillRates()' class='createBtn'> Create </td> </tr>";
        //                 }
        //             } else{
        //                 output += "<td style='text-align: center;'> <button disabled> Preview </td>";
        //                 output += "<td style='text-align: center;'> <button class='createBtn'> Create </td> </tr>";
        //             }
        //         }
        //     }
        //     document.querySelector('#billingPeriod').value = CurrBillMonth;
        //     // document.querySelector('#currentPeriod').innerHTML = currentPeriod;
                ...
                for(var a in consType){
                    ...
                    if(consType[a].id !== ""){
                        if(consType[a].id > 0){
                            ...
                            output += 'data-toggle="modal" data-target="#billRates" billPeriod="' + billingPeriod + '" consType="' + consType[a].ct_desc +'"';
                            output += 'billId ="' + consType[a].id + '" onclick="viewRates(this)"> Preview </button> </td>';
                        } else {
                            output += '<td style="text-align: center;"> <button id="btnRatesDtlChrge" type="button" class="btn btn-primary col-5 m-2"';
                            output += 'data-toggle="modal" data-target="#addBillRates" billPeriod="' + billingPeriod + '" consumerType="' + consType[a].ct_desc + '" consType="' + consType[a].ct_id +'"';
    ...
    function viewRates(x){
        ...
        // xhr.open('GET', 'http://10.12.10.100:8000/api/v1/billing_rates/getRate/'+consType+'/'+date , true);
    ...
    function addRates(){
        ...
        var br_gensys_rate = document.querySelector("#newGenSysCharge").value;
        var br_par_rate = document.querySelector("#newPowerActReduct").value;
        var br_fbhc_rate = document.querySelector("#newFBH").value;
        var br_forex_rate = document.querySelector("#newFAC").value;
        var br_transsys_rate = document.querySelector("#newTranSysCharge").value;
        var br_transdem_rate = document.querySelector("#newTransDemCharge").value;
        var br_sysloss_rate = document.querySelector("#newSysLossCharge").value;
        var br_distsys_rate = document.querySelector("#newDistSysCharge").value;
        var br_distdem_rate = document.querySelector("#newDistDemCharge").value;
        var br_suprtlcust_fixed = document.querySelector("#newSuppFixCharge").value;
        var br_supsys_rate = document.querySelector("#newSuppSysCharge").value;
        var br_mtrrtlcust_fixed = document.querySelector("#newMeterFixCharge").value;
        var br_mtrsys_rate = document.querySelector("#newMeterSysCharge").value;
        var br_lfln_subs_rate = document.querySelector("#newLifelineDiscSub").value;
        var br_sc_subs_rate = document.querySelector("#newSrCitDiscSub").value;
        var br_intrclscrssubrte = document.querySelector("#newIntClassCrossSub").value;
        var br_capex_rate = document.querySelector("#newMCC").value;
        var br_loancon_rate_kwh = document.querySelector("#newLoanCondo").value;
        var br_loancon_rate_fix = document.querySelector("#newLoanCondoFix").value;
        var br_uc4_miss_rate_spu = document.querySelector("#newMisElectSPUG").value;
        var br_uc4_miss_rate_red = document.querySelector("#newMisElectRED").value;
        var br_uc6_envi_rate = document.querySelector("#newEnvCharge").value;
        var br_uc5_equal_rate = document.querySelector("#newEqTaxRoyalty").value;
        var br_uc2_npccon_rate = document.querySelector("#newNPCStranCons").value;
        var br_uc1_npcdebt_rate = document.querySelector("#newNPCStranDebt").value;
        var br_fit_all = document.querySelector("#newFITALL").value;
        var br_vat_gen = document.querySelector("#newGenVAT").value;
        var br_vat_par = document.querySelector("#newPowerActRedVAT").value;
        var br_vat_trans = document.querySelector("#newTranSysVAT").value;
        var br_vat_transdem = document.querySelector("#newTransDemVAT").value;
        var br_vat_systloss = document.querySelector("#newSysLossVAT").value;
        var br_vat_distrib_kwh = document.querySelector("#newDistSysVAT").value;
        var br_vat_distdem = document.querySelector("#newDistDemVAT").value;
        var br_vat_supsys = document.querySelector("#newSuppSysVAT").value;
        var br_vat_supfix = document.querySelector("#newSuppFixVAT").value;
        var br_vat_mtr_fix = document.querySelector("#newMeterFixVAT").value;
        var br_vat_metersys = document.querySelector("#newMeterSysVAT").value;
        var br_vat_lfln = document.querySelector("#newLflnDiscSubs").value;
        var br_vat_loancondo = document.querySelector("#newLoanCondoVAT").value;
        var br_vat_loancondofix = document.querySelector("#newLoanCondoFixVAT").value;
        var Other_Vat = document.querySelector("#newOtherVAT").value;
        var br_energy_chrg = document.querySelector("#addTotalKWHchrge").innerHTML;
        var br_ttl_dmd_chrg = document.querySelector("#addTotalDmdChrge").innerHTML;
        var br_ttl_fix_chrg = document.querySelector("#addTotalFixChrge").innerHTML;

        const toSend = {
            user_id: userId,
            cons_type_id: consId,
            br_billing_ym: parseInt(billMonth),
            br_gensys_rate: br_gensys_rate, 
            br_fbhc_rate: br_fbhc_rate, 
            br_forex_rate: br_forex_rate, 
            br_icera_rate: 0, 
            br_gram_rate: 0,
            br_par_rate: br_par_rate,
            br_transdem_rate: br_transdem_rate,
            br_transsys_rate: br_transsys_rate,
            br_sysloss_rate: br_sysloss_rate, 
            br_distdem_rate: br_distdem_rate, 
            br_distsys_rate: br_distsys_rate, 
            br_suprtlcust_fixed: br_suprtlcust_fixed,
            br_supsys_rate: br_supsys_rate, 
            br_mtrrtlcust_fixed: br_mtrrtlcust_fixed,
            br_mtrsys_rate: br_mtrsys_rate, 
            br_loancon_rate_kwh: br_loancon_rate_kwh,
            br_loancon_rate_fix: br_loancon_rate_fix,
            br_lfln_subs_rate: br_lfln_subs_rate,
            br_sc_subs_rate: br_sc_subs_rate,
            br_uc1_npcdebt_rate: br_uc1_npcdebt_rate, 
            br_uc2_npccon_rate: br_uc2_npccon_rate, 
            br_uc3_duscon_rate: 0, 
            br_uc4_miss_rate_spu: br_uc4_miss_rate_spu, 
            br_uc5_equal_rate: br_uc5_equal_rate, 
            br_uc6_envi_rate: br_uc6_envi_rate, 
            br_uc7_crssubremrate: 0,
            br_intrclscrssubrte: br_intrclscrssubrte,
            br_ppa_refund_rate: 0, 
            br_ppa_reco_rate: 0,
            br_patronage_refund: 0,
            br_capex_rate: br_capex_rate, 
            br_mcrpt: 0, 
            br_adj_label: 0,
            br_adj_fixed: 0,
            ...
            br_iccs_adj: 0, 
            br_ppd_adj: 0, 
            br_fit_all: br_fit_all, 
            br_uc4_miss_rate_red: br_uc4_miss_rate_red,
            br_min_lfln_kwh: 0, 
            br_backbill: 0, 
            ...
            br_tax_local: 0, 
            br_tax_business: 0, 
            br_vat_gen: br_vat_gen, 
            br_vat_trans: br_vat_trans, 
            br_vat_systloss: br_vat_systloss, 
            br_vat_distrib_kwh: br_vat_distrib_kwh, 
            ...
            br_luelco_distr: 0,
            br_ngcp_cip2: 0, 
            br_vat_transdem: br_vat_transdem,  
            br_vat_distdem: br_vat_distdem,  
            br_vat_loancondo: br_vat_loancondo, 
            br_vat_loancondofix: br_vat_loancondofix, 
            br_vat_metersys: br_vat_metersys, 
            br_vat_supsys: br_vat_supsys,
            br_vat_supfix: br_vat_supfix,
            br_vat_mtr_fix: br_vat_mtr_fix,
            br_vat_par: br_vat_par,
            br_vat_lfln: br_vat_lfln,
            Other_Vat: Other_Vat,
            br_energy_chrg: parseFloat(br_energy_chrg),
            br_ttl_dmd_chrg: parseFloat(br_ttl_dmd_chrg),
            br_ttl_fix_chrg: parseFloat(br_ttl_fix_chrg)
        }
		console.log(toSend);
    ...
    function updateRates(){
        ...
        var br_gensys_rate = document.querySelector("#genSysCharge").value;
        var br_par_rate = document.querySelector("#powerActReduct").value;
        var br_fbhc_rate = document.querySelector("#FBH").value;
        var br_forex_rate = document.querySelector("#FAC").value;
        var br_transsys_rate = document.querySelector("#tranSysCharge").value;
        var br_transdem_rate = document.querySelector("#transDemCharge").value;
        var br_sysloss_rate = document.querySelector("#sysLossCharge").value;
        var br_distsys_rate = document.querySelector("#distSysCharge").value;
        var br_distdem_rate = document.querySelector("#distDemCharge").value;
        var br_suprtlcust_fixed = document.querySelector("#suppFixCharge").value;
        var br_supsys_rate = document.querySelector("#suppSysCharge").value;
        var br_mtrrtlcust_fixed = document.querySelector("#meterFixCharge").value;
        var br_mtrsys_rate = document.querySelector("#meterSysCharge").value;
        var br_lfln_subs_rate = document.querySelector("#lifelineDiscSub").value;
        var br_sc_subs_rate = document.querySelector("#srCitDiscSub").value;
        var br_intrclscrssubrte = document.querySelector("#intClassCrossSub").value;
        var br_capex_rate = document.querySelector("#MCC").value;
        var br_loancon_rate_kwh = document.querySelector("#loanCondo").value;
        var br_loancon_rate_fix = document.querySelector("#loanCondoFix").value;
        var br_uc4_miss_rate_spu = document.querySelector("#misElectSPUG").value;
        var br_uc4_miss_rate_red = document.querySelector("#misElectRED").value;
        var br_uc6_envi_rate = document.querySelector("#envCharge").value;
        var br_uc5_equal_rate = document.querySelector("#eqTaxRoyalty").value;
        var br_uc2_npccon_rate = document.querySelector("#NPCStranCons").value;
        var br_uc1_npcdebt_rate = document.querySelector("#NPCStranDebt").value;
        var br_fit_all = document.querySelector("#FITALL").value;
        var br_vat_gen = document.querySelector("#genVAT").value;
        var br_vat_par = document.querySelector("#powerActRedVAT").value;
        var br_vat_trans = document.querySelector("#tranSysVAT").value;
        var br_vat_transdem = document.querySelector("#transDemVAT").value;
        var br_vat_systloss = document.querySelector("#sysLossVAT").value;
        var br_vat_distrib_kwh = document.querySelector("#distSysVAT").value;
        var br_vat_distdem = document.querySelector("#distDemVAT").value;
        var br_vat_supsys = document.querySelector("#suppSysVAT").value;
        var br_vat_supfix = document.querySelector("#suppFixVAT").value;
        var br_vat_mtr_fix = document.querySelector("#meterFixVAT").value;
        var br_vat_metersys = document.querySelector("#meterSysVAT").value;
        var br_vat_lfln = document.querySelector("#lflnDiscSubs").value;
        var br_vat_loancondo = document.querySelector("#loanCondoVAT").value;
        var br_vat_loancondofix = document.querySelector("#loanCondoFixVAT").value;
        var br_energy_chrg = document.querySelector("#totalKWHchrge").innerHTML;
        var br_ttl_dmd_chrg = document.querySelector("#totalDmdChrge").innerHTML;
        var br_ttl_fix_chrg = document.querySelector("#totalFixChrge").innerHTML;
        ...
        const toSend = {
            ...
            'br_vat_loancondo': br_vat_loancondo,
            'br_vat_loancondofix': br_vat_loancondofix,
            'br_energy_chrg': br_energy_chrg,
            'br_ttl_dmd_chrg': br_ttl_dmd_chrg,
            'br_ttl_fix_chrg': br_ttl_fix_chrg
        }
    ...
    function calculateRates(){
        ...
        for(var i=0; i<inputs.length; i++){
            inputs[i].addEventListener("keyup", function(){
                var br_gensys_rate = 0; 
                var br_par_rate = 0;
                var br_fbhc_rate = 0;
                var br_forex_rate = 0;
                var br_transsys_rate = 0;
                var br_transdem_rate = 0;
                var br_sysloss_rate = 0;
                var br_distsys_rate = 0;
                var br_distdem_rate = 0;
                var br_suprtlcust_fixed = 0;
                var br_supsys_rate = 0;
                var br_mtrrtlcust_fixed = 0;
                var br_mtrsys_rate = 0;
                var br_lfln_subs_rate = 0;
                var br_sc_subs_rate = 0;
                var br_intrclscrssubrte = 0;
                var br_capex_rate = 0;
                var br_loancon_rate_kwh = 0;
                var br_loancon_rate_fix = 0;
                var br_uc4_miss_rate_spu = 0;
                var br_uc4_miss_rate_red = 0;
                var br_uc6_envi_rate = 0;
                var br_uc5_equal_rate = 0;
                var br_uc2_npccon_rate = 0;
                var br_uc1_npcdebt_rate = 0;
                var br_fit_all = 0;
                var br_vat_gen = 0;
                var br_vat_par = 0;
                var br_vat_trans = 0;
                var br_vat_transdem = 0;
                var br_vat_systloss = 0;
                var br_vat_distrib_kwh = 0;
                var br_vat_distdem = 0;
                var br_vat_supsys = 0;
                var br_vat_supfix = 0;
                var br_vat_mtr_fix = 0;
                var br_vat_metersys = 0;
                var br_vat_lfln = 0;
                var br_vat_loancondo = 0;
                var br_vat_loancondofix = 0;
                var Other_Vat = 0;
