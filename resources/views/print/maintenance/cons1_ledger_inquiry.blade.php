...
<script>
    ...
    var date = (today.getMonth()+1) + "/" + today.getDate() + "/" + today.getFullYear();
            ...
            if(l >= 58 || l == 54){
                ...
                output += '<label>Position:&nbsp Teller</label><br>';
                output += '</div>';
                ...
                output += '<tr><td>' + 'Reconnection Fee:' +'</td><td>' +data.Reconnection_FEE.toLocaleString("en-US", { minimumFractionDigits: 2 })+'</td></tr>';
                output += '<tr><td>' + 'Total:' +'</td><td>' +data.Total_Unpaid_Bills.toLocaleString("en-US", { minimumFractionDigits: 2 })+'</td></tr>';
                output += '</table>';
                output += '</div>';
                output += '</div><div class="page-break"></div><br>';
