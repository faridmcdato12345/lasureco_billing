...
<head>
    ...
    <title> Print Sales versus Collections Report </title>
</head>
<style media="print">
    @page {
        size: A4;
    ...
    function getData(){
        ...
        xhr.onload = function(){
            if(xhr.status == 200){
                ...
                output += '<th class="left top bot"> Deposit </th>';
                output += '<th class="left top bot"> Applied </th>';
                output += '</tr>';
                ...
                for(var i in Message){
                    ...
                    if(num > 0 && num % 50 == 0){
                        ...
                        output += '<td class="left"> &nbsp;' + Message[i].Total_Deposit.toLocaleString("en-US", { minimumFractionDigits: 2 }) + '</td>';
                        output += '<td class="left"> &nbsp;' + Message[i].Total_Applied.toLocaleString("en-US", { minimumFractionDigits: 2 }) + '</td>';
                        output += '</tr>';

                        totalSales += Message[i].Total_Sales;
                        totalCollections += Message[i].Total_Collection;
                        totalUncollected += uncollected;
                        totalDeposit += Message[i].Total_Deposit;
                        totalApplied += Message[i].Total_Applied;
                    }
                    else{
                        if(param.selected == "all") {
                            output += '<td class="left" style="text-align: left !important;"> &nbsp;&nbsp;&nbsp;' + i + '</td>';
                ...
                output += "<td class='left top'>" + totalUncollected.toLocaleString("en-US", { minimumFractionDigits: 2 }) + "</td>";
                output += "<td class='left top'>" + totalDeposit.toLocaleString("en-US", { minimumFractionDigits: 2 }) + "</td>";
                output += "<td class='left top'>" + totalApplied.toLocaleString("en-US", { minimumFractionDigits: 2 }) + "</td></tr>";
                output += "</table>";
