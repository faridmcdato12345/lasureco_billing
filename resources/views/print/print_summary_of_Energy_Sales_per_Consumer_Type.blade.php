    ...
    function getData(){
        ...
        xhr.onload = function(){
            if(xhr.status == 200){
                ...
                output += '<td rowspan=2 class="left top bot"> Consumer Type </td>';
                ...
                output += '<th class="left top bot"> Sen.Cit. <br> Disc./Subs. </th>';
                ...
                for(var int in details){
                    if(int !== "STREETLIGHTS"){
                        ...
                        output += "<tr> <td class='left' style='text-align: left !important;'> &nbsp; STRTLGHTS </td>";
                    }
