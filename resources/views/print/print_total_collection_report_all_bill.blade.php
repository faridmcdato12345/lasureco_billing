...
<head>
    ...
    <title> Print Total Collection Report (All bill) </title>
</head>
<style media="print">
    @page {
        size: A4;
...
<script>
    ...
    function getData(){
        ...
        var totalCollection = "{{route('collection.report.allbill')}}";
        ...
        xhr.onload = function(){
            if(xhr.status == 200){
                ...
                output += '<label style="font-size: 20px;"> TOTAL COLLECTION REPORT (ALL BILL) </label> <br>';
                ...
                output += '<th class="left top bot"> Total Non-bill </th>';
                ...
                for(var i in details){
                    ...
                    if(num > 0 && num % 50 == 0){
                        ...
                        output += '<td class="left"> &nbsp;' + details[i].Total_Non_Bill.toLocaleString("en-US", { minimumFractionDigits: 2 }) + '</td>';
                ...
                output += "<td class='left top'>" + totalNonbill.toLocaleString("en-US", { minimumFractionDigits: 2 }) + "</td>";
