...
<head>
    ...
    <title> Print Increase in Consumption </title>
...
<script>
    ...
    function getData(){
        ...
        var increaseConsumption = "{{route('report.increase.consumption')}}";
        xhr.open('POST', increaseConsumption, true);
        ...
        xhr.onload = function(){
            if(xhr.status == 200){
                ...
                output += '<label style="font-size: 20px;"> INCREASE IN CONSUMPTION </label><br>';
