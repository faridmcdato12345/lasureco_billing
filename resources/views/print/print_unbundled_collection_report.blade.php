...
<head>
    ...
    <title> Unbundled Collection Report </title>
</head>
<style media="print">
    @page {
...
<script>
    ...
    function getData(){
        ...
        var unbundled = "{{route('report.collection.unbundled')}}";
        xhr.open('POST', unbundled, true);
        ...
        xhr.onload = function(){
            if(xhr.status == 200){
                ...
                output += "<label style='font-size: 20px;'> UNBUNDLED COLLECTION REPORT </label> <br>";
                output += '<label style="font-size: 15px;">' + months[month - 1] + ' ' + day + ', ' + year;
                ...
                output += '<th class="left top bot" rowspan=2> Teller </th>';
                ...
                output += '<th rowspan=2 class="top left bot" rowspan=2> Membership </th>';
                ...
                for(var x=0; x<data.info.length; x++){
                    output += "<tr> <td class='left'>" + data.info[x].teller + "</td>";
                    output += "<td class='left'>" + data.info[x].amount_paid.toLocaleString("en-US") + "</td>";
                    totalTotal += data.info[x].amount_paid;
                    output += "<td class='left'>" + data.info[x].no_bill.toLocaleString("en-US") + "</td>";
                    totalNoBills += data.info[x].no_bill;
                    output += "<td class='left'>" + data.info[x].kwh.toLocaleString("en-US") + "</td>";
                    totalKWH += data.info[x].kwh;
                    output += "<td class='left'>" + data.info[x].actual_power_bill.toLocaleString("en-US") + "</td>";
                    totalAmount += data.info[x].actual_power_bill;
                ...
                output += "<td class='left top'>" + totalNoBills.toLocaleString("en-US") + "</td>";
                ...
                output += '<tr> <th class="left top bot" rowspan=2> Teller </th>';
                output += '<th class="left top bot" colspan=6> Other Charges </th>'; 
                output += '<th class="left top bot" colspan=6> Universal Charges </th>'; 
                output += '<th class="left top bot" rowspan=2> Fit All (Renew) </th>'; 
                output += '<th class="left top bot" colspan=15> Value Added Tax </th></tr>'; 
                ...
                output += '<th class="left bot"> Loan Codonation </th>'; 
                output += '<th class="left bot"> Loan Codon Fix </th>'; 
                ...
                for(var x=0; x<data.info.length; x++){
                    output += "<tr> <td class='left'>" + data.info[x].teller.toLocaleString("en-US") + "</td>";
