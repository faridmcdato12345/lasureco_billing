    ...
    function getData(){
        ...
        xhr.onload = function(){
            if(xhr.status == 200){
                ...
                var pub2Cons = 0;
                var pub2KwhUsed = 0;
                var pub2BillAmount = 0;
                var com2NoCons = 0;
                var com2KwhUsed = 0;
                var com2BillAmount = 0;
                var commwat2NoCons = 0;
                var commwat2KwhUsed = 0;
                var commwat2BillAmount = 0;
                ...
                if(consTypeDetails[8].length == 0){
                    output += "<table style='float: left; width: 30%; border-bottom: 0.75px dashed; border-right: 0.75px dashed; margin-top: 3%;'> <tr>";
                    output += '<th colspan=4 class="left top">' + consType[8].ct_desc + '<br> </th></tr><tr>';
                    output += '<th class="left top bot" width="20%;"> No of Cons <br> </th>';
                    output += '<th class="left top bot"  width="25%;"> Total KWh <br> Used </th>';
                    output += '<th class="left top bot"  width="25%;"> Bill <br> Amount </th>';
                    for(var x in generalReport){
                        output += "<tr><td class='left'>  0 </td>";
                        output += "<td class='left'>  0.00 </td>"; 
                        output += "<td class='left'>  0.00 </td> </tr>";
                    ...
                    for(var x in generalReport){
                        if(consTypeDetails[8][x] !== undefined){
                            output += "<tr><td class='left'> " + consTypeDetails[8][x][consType[8].ct_desc].No_of_Cons + "</td>";
                            output += "<td class='left'> " + consTypeDetails[8][x][consType[8].ct_desc].Total_KWH_USED.toLocaleString("en-US", { minimumFractionDigits: 2 }) + "</td>";
                            output += "<td class='left'> " + consTypeDetails[8][x][consType[8].ct_desc].Bill_Amount.toLocaleString("en-US", { minimumFractionDigits: 2 }) + "</td> </tr>";
                            pub2Cons += consTypeDetails[8][x][consType[8].ct_desc].No_of_Cons;

                            pub2KwhUsed += consTypeDetails[8][x][consType[8].ct_desc].Total_KWH_USED;
                            pub2BillAmount += consTypeDetails[8][x][consType[8].ct_desc].Bill_Amount;
                        } else {
                            output += "<tr> <td class='left'> 0 </td>";
                            output += "<td class='left'> 0.00 </td>";
                            output += "<td class='left'> 0.00 </td> </tr>";
                    ...
                    output += "<tr> <td class='left top'>" + pub2Cons + "</td>";
                    output += "<td class='left top'>" + pub2KwhUsed.toLocaleString("en-US", { minimumFractionDigits: 2 }) + "</td>";
                    output += "<td class='left top'>" + pub2BillAmount.toLocaleString("en-US", { minimumFractionDigits: 2 }) + "</td> </tr>";
                    output += "</table>";
                }
                
                if(consTypeDetails[9].length == 0){
                    output += "<table style='float: left; width: 25%; border-bottom: 0.75px dashed; border-right: 0.75px dashed; margin-top: 3%;'> <tr>";
                    output += '<th colspan=4 class="left top">' + consType[9].ct_desc + '<br> </th></tr><tr>';
                    output += '<th class="left top bot" width="20%;"> No of Cons <br> </th>';
                    output += '<th class="left top bot" width="25%;"> Total KWh <br> Used </th>';
                    output += '<th class="left top bot" width="25%;"> Bill <br> Amount </th>';
                    for(var x in generalReport){
                    ...
                    for(var x in generalReport){
                        if(consTypeDetails[9][x] !== undefined){
                            output += "<tr> <td class='left'> " + consTypeDetails[9][x][consType[9].ct_desc].No_of_Cons + "</td>";
                            output += "<td class='left'> " + consTypeDetails[9][x][consType[9].ct_desc].Total_KWH_USED.toLocaleString("en-US", { minimumFractionDigits: 2 }) + "</td>";
                            output += "<td class='left'> " + consTypeDetails[9][x][consType[9].ct_desc].Bill_Amount.toLocaleString("en-US", { minimumFractionDigits: 2 }) + "</td> </tr>";
                            com2NoCons += consTypeDetails[9][x][consType[9].ct_desc].No_of_Cons;

                            com2KwhUsed += consTypeDetails[9][x][consType[9].ct_desc].Total_KWH_USED;
                            com2BillAmount += consTypeDetails[9][x][consType[9].ct_desc].Bill_Amount;
                        } else {
                            output += "<tr> <td class='left'> 0 </td>";
                            output += "<td class='left'> 0.00 </td>";
                            output += "<td class='left'> 0.00 </td> </tr>";
                    ...
                    output += "<tr> <td class='left top'>" + com2NoCons + "</td>";
                    output += "<td class='left top'>" + com2KwhUsed.toLocaleString("en-US", { minimumFractionDigits: 2 }) + "</td>";
                    output += "<td class='left top'>" + com2BillAmount.toLocaleString("en-US", { minimumFractionDigits: 2 }) + "</td> </tr>";
                    output += "</table>";
                }

                if(consTypeDetails[10].length == 0){
                    output += "<table style='float: left; width: 40%; border-bottom: 0.75px dashed; margin-top: 3%;'> <tr>";
                    output += '<th colspan=4 class="left top right">' + consType[10].ct_desc + '<br> </th></tr><tr>';
                    output += '<th class="left top bot" style="width: 45% !important;"> Route </th>';
                    output += '<th class="left top bot"> No of <br> Cons </th>';
                    output += '<th class="left top bot"> Total KWh <br> Used </th>';
                    output += '<th class="left top bot right"> Bill <br> Amount </th>';
                    ...
                    for(var x in generalReport){
                        ...
                        if(consTypeDetails[10][x] !== undefined){
                            output += "<tr> <td class='left' style='text-align: left;'>" + x + " " + routeName + "</td>";
                            output += "<td class='left'> " + consTypeDetails[10][x][consType[10].ct_desc].No_of_Cons + "</td>";
                            output += "<td class='left'> " + consTypeDetails[10][x][consType[10].ct_desc].Total_KWH_USED.toLocaleString("en-US", { minimumFractionDigits: 2 }) + "</td>";
                            output += "<td class='left right'> " + consTypeDetails[10][x][consType[10].ct_desc].Bill_Amount.toLocaleString("en-US", { minimumFractionDigits: 2 }) + "</td> </tr>";
                            commwat2NoCons += consTypeDetails[10][x][consType[10].ct_desc].No_of_Cons;
                            commwat2KwhUsed += consTypeDetails[10][x][consType[10].ct_desc].Total_KWH_USED;
                            commwat2BillAmount += consTypeDetails[10][x][consType[10].ct_desc].Bill_Amount;
                        } else {
                            output += "<tr> <td class='left' style='text-align: left;'>" + x + " " + routeName + "</td>";
                            output += "<td class='left'> 0 </td>";
                            output += "<td class='left'> 0.00 </td>";
                    ...
                    output += "<tr> <td class='left top' style='text-align: left;'> </td>";
                    output += "<td class='left top'>" + commwat2NoCons + "</td>";
                    output += "<td class='left top'>" + commwat2KwhUsed.toLocaleString("en-US", { minimumFractionDigits: 2 }) + "</td>";
                    output += "<td class='left top right'>" + commwat2BillAmount.toLocaleString("en-US", { minimumFractionDigits: 2 }) + "</td> </tr>";
                    output += "</table>";
                }
