...
<head>
    ...
    <title>Print Summary of Bills - Additional</title>
        ...
        xhr.onload = function(){
            if(xhr.status == 200){
                ...
                if(recap == "No") {
                    ...
                    output += '<label style="font-size: 18px;"> SUMMARY OF BILLS - ADDITIONAL </lable> <br><br>';
                    ...
                    for(var i in summBill){
                        ...
                        if(num > 0 && num % 19 == 0){
                            ...
                            output += '<td class="left">' + summBill[i].Acc_No + '</td>';
                            ...
                            output += '<td class="left">' + summBill[i].Demand_Used + '</td>';
					...
					output += "<td> </td> <td class='left'>" + TotSumBill.Total_Demand_Used + "</td>";
