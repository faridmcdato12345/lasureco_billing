...
class OnlineConsumerRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'ct_id' => 'required',
            // 'tin' => 'nullable',
            'cm_last_name' =>'required|max:255',
            'cm_first_name' => 'required|max:255',
            'cm_middle_name' => 'required|max:255',
            'cm_full_name' => 'required|max:255',
            'cm_address' => 'bail|required|max:255',
            'cm_birthdate' => 'required|date',
